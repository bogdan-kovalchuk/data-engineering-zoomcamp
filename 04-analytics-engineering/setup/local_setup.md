...
Use this exact command sequence from the repository root:
...
Copy-Item setup/profiles.yml.example "$HOME/.dbt/profiles.yml" -Force
```

```bash
python setup/load_taxi_data.py
```
