...
- **4 GB RAM**: You will very likely hit OOM. Use selective builds and lower memory settings.
- **8 GB RAM**: You might hit OOM on some models. Tune `memory_limit` and build models step-by-step.
